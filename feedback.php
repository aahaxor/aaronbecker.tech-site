...
$mailto = 'aaron.becker@gmail.com' ;
$subject = "Feedback Form Response" ;
$formurl = "http://aaronbecker.tech/" ;
$thankyouurl = "http://aaronbecker.tech/thanks.html" ;
$errorurl = "http://aaronbecker.tech/error.html?e=form" ;
$want_tel_field = 0;
$want_addr_field = 0;
...
$my_recaptcha_private_key = '6LcAfhkUAAAAABbauH4Sy0NaOEY9qpCnLUfgXsfC' ;
...
if (($email_is_required && (empty($email) || (substr_count($email,'@') != 1))) || (strlen($email) > 254) || preg_match("/[\s<>,'\"]/", $email) ||
    ...
    header( "Location: $errorurl"."FieldBlank" );
    exit ;
}
...
if (strlen( $my_recaptcha_private_key )) {
    ...
    if ($recaptcha_decoded == NULL || (trim($recaptcha_decoded['success']) != TRUE)) {
        header( "Location: $errorurl"."RecapchaError" );
        exit ;
    }
}
